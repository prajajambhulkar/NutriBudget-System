...
try:
    ...
    st.error("Please run the training blocks inside Google Colab first to generate model files!")
    st.stop()
...
if not selected_items:
    ...
    # Filter dataset for items currently inside user's active checkout cart
    ...
    with col2:
        ...
        # 🚨 Health Alert Evaluation Triggers
        ...
        # 🛍 Smart Alternatives Swaps Output
        ...
        # 🏃 Lifestyle Exercise Router Mapping Blueprint
